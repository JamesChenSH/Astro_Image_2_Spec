...
class AstroImage2SpecModel(nn.Module):
    def __init__(
        ...
        self.encoder = TransformerEncoder(embedding_dim, head_num, ff_dim, dropout_rate, attn_dropout, num_enc_layers)
        self.decoder = TransformerDecoder(embedding_dim, head_num, ff_dim, dropout_rate, attn_dropout, num_dec_layers)
